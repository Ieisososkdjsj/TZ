...
# Техническое задание
## на разработку программного комплекса "Научно-ислледовательской организации"

### 1. Введение
Работа выполняется в рамках проекта «Автоматизированная система управления и учёта для научно-ислледовательской организации ООО "САФИТ"».

### 2. Основание для разработки
- **Договор**: № 0001-24С от 12 января 2024 г.
- **Наименование работы**: «Программный комплекс управления научно-ислледовательской организации»
- **Исполнитель**: ООО «САФИТ»
- **Соисполнители**: нет

### 3. Назначение разработки
Создание программного комплекса для оперативного управления проектами, контроля сроков, учёта материалов и ресурсов, а также формирования отчётности для научно-ислледовательской организации.
...
- Управление портфелем производственных продуктов
...
- **Серверная часть**: ОС Windows Server 2019
...
|---|----------------|-------------|------------------|
| 1 | Анализ требований и проектирование архитектуры системы | 01.01.2024 - 31.02.2024 | Утверждённое ТЗ и архитектурный проект |
| 2 | Разработка ядра системы и модуля управления объектами | 01.02.2024 - 31.03.2024 | Рабочий прототип системы с базовым функционалом |
| 3 | Разработка модулей складского учёта и сырья | 01.04.2024 - 31.05.2024 | Полная версия программного комплекса |
| 4 | Тестирование и пилотное внедрение на производстве | 01.06.2024 - 30.07.2024 | Внедренная система для всего производства|
| 5 | Полное внедрение, доработка и обучение персонала | 01.08.2024 - 30.09.2024 | Работающая система во всех отделах компании |
